...
extern "C" SEXP _packmalaria_dust2_system_sir_alloc(SEXP r_pars, SEXP r_time, SEXP r_time_control, SEXP r_n_particles, SEXP r_n_groups, SEXP r_seed, SEXP r_deterministic, SEXP r_n_threads) {
  BEGIN_CPP11
...
extern "C" SEXP _packmalaria_dust2_system_sir_run_to_time(SEXP ptr, SEXP r_time) {
  BEGIN_CPP11
...
extern "C" SEXP _packmalaria_dust2_system_sir_state(SEXP ptr, SEXP r_index_state, SEXP r_index_particle, SEXP r_index_group, SEXP preserve_particle_dimension, SEXP preserve_group_dimension) {
  BEGIN_CPP11
...
extern "C" SEXP _packmalaria_dust2_system_sir_time(SEXP ptr) {
  BEGIN_CPP11
...
extern "C" SEXP _packmalaria_dust2_system_sir_set_state_initial(SEXP ptr) {
  BEGIN_CPP11
...
extern "C" SEXP _packmalaria_dust2_system_sir_set_state(SEXP ptr, SEXP r_state) {
  BEGIN_CPP11
...
extern "C" SEXP _packmalaria_dust2_system_sir_reorder(SEXP ptr, SEXP r_index) {
  BEGIN_CPP11
...
extern "C" SEXP _packmalaria_dust2_system_sir_rng_state(SEXP ptr) {
  BEGIN_CPP11
...
extern "C" SEXP _packmalaria_dust2_system_sir_set_rng_state(SEXP ptr, SEXP r_rng_state) {
  BEGIN_CPP11
...
extern "C" SEXP _packmalaria_dust2_system_sir_set_time(SEXP ptr, SEXP r_time) {
  BEGIN_CPP11
...
extern "C" SEXP _packmalaria_dust2_system_sir_update_pars(SEXP ptr, SEXP pars) {
  BEGIN_CPP11
...
extern "C" SEXP _packmalaria_dust2_system_sir_simulate(SEXP ptr, SEXP r_times, SEXP r_index_state, SEXP preserve_particle_dimension, SEXP preserve_group_dimension) {
  BEGIN_CPP11
...
static const R_CallMethodDef CallEntries[] = {
    ...
    {"_packmalaria_dust2_system_sir_alloc",               (DL_FUNC) &_packmalaria_dust2_system_sir_alloc,               8},
    {"_packmalaria_dust2_system_sir_reorder",             (DL_FUNC) &_packmalaria_dust2_system_sir_reorder,             2},
    {"_packmalaria_dust2_system_sir_rng_state",           (DL_FUNC) &_packmalaria_dust2_system_sir_rng_state,           1},
    {"_packmalaria_dust2_system_sir_run_to_time",         (DL_FUNC) &_packmalaria_dust2_system_sir_run_to_time,         2},
    {"_packmalaria_dust2_system_sir_set_rng_state",       (DL_FUNC) &_packmalaria_dust2_system_sir_set_rng_state,       2},
    {"_packmalaria_dust2_system_sir_set_state",           (DL_FUNC) &_packmalaria_dust2_system_sir_set_state,           2},
    {"_packmalaria_dust2_system_sir_set_state_initial",   (DL_FUNC) &_packmalaria_dust2_system_sir_set_state_initial,   1},
    {"_packmalaria_dust2_system_sir_set_time",            (DL_FUNC) &_packmalaria_dust2_system_sir_set_time,            2},
    {"_packmalaria_dust2_system_sir_simulate",            (DL_FUNC) &_packmalaria_dust2_system_sir_simulate,            5},
    {"_packmalaria_dust2_system_sir_state",               (DL_FUNC) &_packmalaria_dust2_system_sir_state,               6},
    {"_packmalaria_dust2_system_sir_time",                (DL_FUNC) &_packmalaria_dust2_system_sir_time,                1},
    {"_packmalaria_dust2_system_sir_update_pars",         (DL_FUNC) &_packmalaria_dust2_system_sir_update_pars,         2},
